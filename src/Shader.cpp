...
{
	Engine::ShaderProgram::OutputData shaderOutput = {};
	...
	if (shaderOutput.breakPoint) {
		output += "Break Point generated by the shader";
		std::cout << output;
		abort();
	}
...
int Engine::ShaderProgram::GetAttributeLocation(Engine::ShaderProgram::ShaderAttribute attribute)
{
